...
class TestSFLFunctionsUnit(BaseUnitTestCase):
    ...
    def test_sfl_trhph_chloride(self):
        ...
        """
        test_array = np.array([
            [0.906, 4.095, 4.095, 11.8, 4.530, 0.2208, np.nan, np.nan],
            [0.890, 4.095, 4.095, 15.9, 4.450, 0.2247, np.nan, np.nan],
            [0.891, 4.095, 4.095, 3.2, 4.455, 0.2245, np.nan, np.nan],
            [0.184, 0.915, 4.064, 67.7, 0.915, 1.0929, np.nan, np.nan],
            [0.198, 1.002, 4.095, 75.8, 1.002, 0.9980, np.nan, np.nan],
            [0.172, 0.857, 4.082, 97.5, 0.857, 1.1669, np.nan, np.nan],
            [0.183, 0.926, 4.076, 95.0, 0.926, 1.0799, np.nan, np.nan],
            [0.233, 1.182, 4.072, 96.2, 1.182, 0.8460, np.nan, np.nan],
